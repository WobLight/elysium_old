...
{
    Unit *target = GetTarget();
    target->ApplyAttackTimePercentMod(BASE_ATTACK, m_modifier.raw(), apply);
    target->ApplyAttackTimePercentMod(OFF_ATTACK, m_modifier.raw(), apply);
    target->ApplyAttackTimePercentMod(RANGED_ATTACK, m_modifier.raw(), apply);
}
